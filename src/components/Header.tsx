...
import useAnimatedNavToggler from "../helpers/AnimatedNavToggler";
...
`;
export const MobileNavLinks: any = motion(styled.div`
 ...
 */
const collapseBreakPointCssMap: { [index: string]: any } = {
  sm: {
